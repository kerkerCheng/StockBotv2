...
<先列需要人工判斷，再列主力 QQQ／TQQQ／LON:VWRA／SOXX／00631L.TW／2330.TW／00981A.TW；每一檔都輸出一句 mobile-friendly TL;DR，包含 🟢可評估／🟡冷卻／⚪觀察／🔴資料不足文字燈號、RSI 所在區間（<30 超賣區、30–50 弱／中性、50–70 偏強、>70 過熱；僅解讀、不代表買賣）、1／5／20 日漲跌、距高點或趨勢／回檔判讀、pace 與資本限制。不得只列 raw 數字；個股與其他仍可縮成摘要，但每檔保留同樣一句焦點>
