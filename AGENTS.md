...
Daily authority；唯一權限來源是 `.codex/rules/stockbot-automations.rules` 的十三個窄 fixed entry，涵蓋固定連外、
...
十三個入口是：harvest、Engine C ETL、SEC EDGAR pq1 fetch、Beta snapshot、pending priority list、pq1 drain、
