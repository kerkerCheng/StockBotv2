...
3. **（已完成 2026-07-28）Daily Beta Technical Monitor v1** — plan：[`docs/plans/2026-07-28-001-feat-daily-beta-technical-monitor-plan.md`](docs/plans/2026-07-28-001-feat-daily-beta-technical-monitor-plan.md)。
   ...
   - **Phase II：** household capital authority、ETF point-in-time完整look-through、live policy promotion、explicit-fill-only Sheet narrow writer；只有本機漏跑不可接受、需要intraday／market-close即時通知或provider SLA時才升級最小server worker。Paywall ROI與通用Daily runner仍留相鄰backlog，不納入本切片。
