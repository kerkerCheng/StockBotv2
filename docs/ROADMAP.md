...
Step 3 Entry Logic ✅（2026-09-06）
  ...
  → Step 4 Full-chain adversarial acceptance ✅（2026-09-07，CONDITIONAL GO）
...
前置：`python scripts/backup_private.py run --no-drive`（Step 4 的 CONDITIONAL 條件）。
