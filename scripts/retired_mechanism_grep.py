...
KEEP: dict[tuple[str,str],str] = {
    ...
    ('crons/daily_brief_prompt.md','G'): 'retirement_note: daily prompt 的 decision_lab today／reassess-stale／decision_review go 三處退役註記（測試斷言可執行行不含它們）',
    ('decision_lab/__init__.py','G'): 'kept_file: 舊 Decision Store 的唯讀歷史檔案館（frozen 2026-09-22）',
    ('decision_lab/bootstrap.py','G'): 'kept_file: open_default_store（備份還原與唯讀讀取端用）',
    ...
    ('tests/test_codex_daily_permissions.py','G'): 'guard_assertion: 斷言 decision_lab today 與 reassess-stale 兩條 rule 必須不在',
    ...
    ('tests/test_routine_prompts.py','G'): 'guard_assertion: 斷言 daily prompt 可執行行不含 decision_lab today／reassess-stale',
