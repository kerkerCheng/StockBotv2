...
#: parse 端把沒有這個欄位的紀錄讀成 `value_date_convention=None`（unspecified）。
RECORD_VERSION = "valuation-assumption/v2"
LEGACY_RECORD_VERSION = "valuation-assumption/v1"
...
__all__ = [
    "LEGACY_RECORD_VERSION", "RECORD_VERSION", "new_valuation_assumption_id", "parse_valuation_assumption_record",
