...
**新增 disproof 條件（2026-07-12，L7 review 決議）：** 若 2026-08-27 重編後 Q2 財報證實營收不當認列達 Ningi 指控量級（~97M SEK / 31%），或審計出具持續經營保留意見 → 本 thesis 轉 `retired`。
**核查頻率與觸發動作：** 每週掃描（weekly signal scan）自動監控；關鍵核查點 2026-07-16（鎖股到期）、2026-08-27（Q2+重編，真相分辨點）、2026-11-26（Q3）。任一核查點觸發 → 48 小時內人工決策。
**持倉決議（2026-07-12）：** 持有人選擇維持現有部位至 8/27 分辨點，屬有意識的 review 決策（非未處理）。
