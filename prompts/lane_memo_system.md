...
4. **Variant Perception 必填**（可放在第 1 段或獨立段落）：
   ...
   **X 必須由「當前股價/估值倍數本身」隱含的假設反推，不是分析師目標價或賣方共識。**
   股價是市場實際的下注；分析師目標價只是另一組人的看法。若股價遠高於分析師目標價，代表
   **市場（股價）比賣方樂觀**、已把利多 price in（X = 樂觀情境已成定局）；若股價遠低於目標價則相反。
   先判斷「以現價/現倍數在買的人，必須相信什麼才划算」＝X，thesis 的 Y 再去挑戰那個 X。
   不要把分析師目標價當成「市場的假設」。若 context 中沒有足夠估值資訊，說明「variant perception 需
   Engine C（基本面引擎）補充估值資料後才能完整填寫」，並給出初步方向。
