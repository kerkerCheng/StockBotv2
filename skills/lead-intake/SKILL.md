...
**這個 skill 就是那道閘門的明文流程。** 它的目的不是怕你忘記判準(判準散在 CLAUDE.md 的 L4/L6/L7/L8
和「來源獨立性鐵律」裡),而是把那些判準從「教訓」翻譯成「**LLM 每次都能照跑的步驟**」,並補上 CLAUDE.md
...
### Step 1 — 拆原子 claim(CLAUDE.md 原本沒有的步驟)
...
### Step 4 — 分層處置(規模化關鍵,CLAUDE.md 缺的那塊)
